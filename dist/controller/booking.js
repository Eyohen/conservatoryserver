...
class BookingController {
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const record = yield Booking.create(Object.assign({}, req.body));
    ...
    readPagination(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const records = yield Booking.findAll({
    ...
    readByID(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const record = yield Booking.findOne({ where: { id } });
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const updated = yield Booking.update(Object.assign({}, req.body), { where: { id: req.params.id } });
                if (updated) {
                    const updatedBooking = yield Booking.findByPk(req.params.id);
