...
class SubMenuController {
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const record = yield SubMenu.create(Object.assign({}, req.body));
    ...
    readPagination(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const records = yield SubMenu.findAll({ where: {}, limit, offset });
    ...
    readByID(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const record = yield SubMenu.findOne({ where: { id } });
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const updated = yield SubMenu.update(Object.assign({}, req.body), { where: { id: req.params.id } });
                if (updated) {
                    const updatedSubMenu = yield SubMenu.findByPk(req.params.id);
